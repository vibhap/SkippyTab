...
//  This is an implementation for credit card validator. We used it from a third party application which in turn uses the luhn algorithm to validate the credit card numbers.
